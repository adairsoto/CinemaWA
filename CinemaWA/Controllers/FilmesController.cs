...
namespace CinemaWA.Controllers
{
    public class FilmesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FilmeId,FilmeNome,Elenco,Tipo")] Filme filme)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FilmeId,FilmeNome,Elenco,Tipo")] Filme filme)
        {
            if (id != filme.FilmeId)
            {
                return NotFound();
