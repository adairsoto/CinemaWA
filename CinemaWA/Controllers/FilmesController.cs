...
namespace CinemaWA.Controllers
{
    public class FilmesController : Controller
    {
        ...
        public FilmesController(CinemaWAContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("FilmeId,FilmeNome,Elenco,Tipo,Sinopse")] Filme filme)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FilmeId,FilmeNome,Elenco,Tipo,Sinopse")] Filme filme)
        {
            if (id != filme.FilmeId)
            {
                return NotFound();
