...
namespace CinemaWA.Controllers
{
    public class SessoesController : Controller
    {
        ...
        public SessoesController(CinemaWAContext context)
        {
            _context = context;
        }
        ...
        {
            var cinemaWAContext = _context.Sessao.Include(s => s.Filme).Include(s => s.Sala);
        ...
        public async Task<IActionResult> Create([Bind("SessaoId,SessaoNome,SessaoInicio,Sessaoinfo,FilmeId,SalaId")] Sessao sessao)
        {
            ...
            ViewData["FilmeId"] = new SelectList(_context.Filme, "FilmeId", "FilmeId", sessao.FilmeId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SessaoId,SessaoNome,SessaoInicio,Sessaoinfo,FilmeId,SalaId")] Sessao sessao)
        {
